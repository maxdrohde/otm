...
df |>
  ...
  aes(x = type,
      ...
      shape = model) +
  geom_point() +
  facet_grid(rand_intercept_sd ~ sample_size) +
  ...
  scale_shape_manual(name = "Model",
                     ...
                     values=c(1:numbers[[1]],
                              ...
                              1:numbers[[6]])) +
  labs(x = "", y = "Power",
       subtitle = "Treatment Effect: Constant effect",
       caption = "") +
...
```{r}
ggsave(
  filename = "otm_sim_power_constant.png", 
  plot = power,
  bg = "white",
  device = ragg::agg_png,
  units="in",
...
df |>
  ...
  scale_shape_manual(name = "Model",
                     ...
                     values=c(1:numbers[[1]],
                              ...
                              1:numbers[[6]])) +
  labs(x = "", y = "Power",
       subtitle = "Treatment Effect: Constant effect + Linear increase to day X",
       caption = "") +
  theme(axis.line.x = element_blank(),
        axis.line.y = element_blank(),
        axis.text.x = element_text(angle = 45, hjust = 1),
...
```{r}
ggsave(
  filename = "otm_sim_power_both.png", 
  plot = power,
  bg = "white",
  device = ragg::agg_png,
  units="in",
